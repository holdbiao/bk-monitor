...
from alarm_backends.service.access.data import AccessDataProcess, AccessRealTimeDataProcess
...
@task(ignore_result=True, queue="celery_service")
def run_access_real_time_data(rt_id, strategies):
    AccessRealTimeDataProcess(rt_id, strategies).process()
