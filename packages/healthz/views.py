...
class HealthzViewSet(IAMPermissionMixin, ResourceViewSet):
    """
    告警配置页面的告警策略
    """

    iam_read_actions = ActionEnum.VIEW_SELF_STATE
    iam_write_actions = ActionEnum.VIEW_SELF_STATE
...
class AllUserViewSet(ResourceViewSet):
    resource_routes = [ResourceRoute("GET", resource.healthz.all_user)]
