  ...
  <div class="loading-done">
    <div class="loading-done-body">
      <div class="loading-done-container">
        <div class="loading-container" v-if="config.loading">
        ...
        <div class="done-container" v-else>
          <i class="icon-monitor icon-duihao success" v-if="config.status"></i>
          <i class="icon-monitor icon-chahao error" v-else></i>
        </div>
      </div>
      <div class="message-container">
        <div class="message-title">{{config.title}}</div>
        <div class="message-text-container" v-if="config.showText">
          <slot name="text">
            <p class="message-text">{{config.text}}</p>
          </slot>
        </div>
      </div>
    </div>
    <div class="loading-done-footer" v-if="config.showFooter">
