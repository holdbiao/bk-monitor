    ...
    "item_list": [
        {
            ...
            "algorithm_list": [
                ...
                {
                    "algorithm_config": [[{"threshold": 100, "method": "lte"}]],
                    "level": 3,
                    "strategy_id": 1,
                    "trigger_config": {"count": 1, "check_window": 5},
                    "algorithm_type": "Threshold",
...
class TestProcessorViews(TestCase):
    ...
    def test_processor_handle(self):
        with mock.patch(
            ...
            assert [_a["level"] for _a in processor.strategy.items[0].algorithm_list] == [level, level]
            ...
            last_checkpoints_key = key.LAST_CHECKPOINTS_CACHE_KEY.get_key()
            ...
            field_list = [
                key.LAST_CHECKPOINTS_CACHE_KEY.get_field(
                    strategy_id=strategy_id, item_id=item_id, dimensions_md5=d, level=level
                )
                for d in dimensions_md5_list
            ]
