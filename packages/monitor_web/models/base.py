...
class OperateRecordModelBase(models.Model):
    ...
    create_user = models.CharField(_("创建人"), max_length=32, blank=True)
    update_time = models.DateTimeField(_("修改时间"), auto_now=True)
    update_user = models.CharField(_("修改人"), max_length=32, blank=True)
