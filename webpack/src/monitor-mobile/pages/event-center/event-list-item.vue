        ...
        <ul
            ...
            <li
                ...
                <template v-if="!itemData.target">
                    <div class="text-row">
                        <span class="row-label">{{ $t('目标2') }}</span><span class="ellipsis">{{ item.target }}</span>
                    </div>
                    <div class="text-row">
                        <span class="row-label">{{ $t('时长2') }}</span><span class="ellipsis">{{ item.duration }}</span>
                    </div>
                </template>
                <template v-else>
                    <div class="msg-item">
