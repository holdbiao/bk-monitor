...
from bkmonitor.dataflow.node.processor import CMDBPrepareAggregateFullNode, CMDBPrepareAggregateSplitNode
from bkmonitor.dataflow.node.source import StreamSourceNode, RelationSourceNode
from bkmonitor.dataflow.node.storage import create_tspider_or_druid_storage_node
...
class CMDBPrepareAggregateTask(BaseTask):
    ...
    def __init__(self, rt_id, agg_interval, agg_method, metric_field, dimension_fields):
        ...
        full_storage_node = create_tspider_or_druid_storage_node(
        ...
        split_storage_node = create_tspider_or_druid_storage_node(
    ...
    @property
    def flow_name(self):
        return "{} {}".format("CMDB预聚合", self.rt_id)
