...
import {
  ...
  IHistoryListItem,
  IQueryConfigsItem,
  IAggMethodList } from '../../pages/data-retrieval/index'
import { listQueryHistory, destroyQueryHistory, createQueryHistory } from '../../../monitor-api/modules/model'
import { getMainlineObjectTopo, getLabel } from '../../../monitor-api/modules/commons'
import { getGraphQueryConfig } from '../../../monitor-api/modules/data_explorer'
import store from '../store'
import { deepClone, transformDataKey, random } from '../../../monitor-common/utils/utils'
...
class DataRetrieval extends VuexModule {
  ...
  public async handleQuery() {
    ...
    const value = this.queryData.targetType === 'INSTANCE'
    ...
    const { data, tips } = await getGraphQueryConfig(params, { needRes: true }).catch(() => [])
      .finally(() => {
