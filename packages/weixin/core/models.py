...
class BkWeixinUser(models.Model):
    ...
    openid = models.CharField(_("微信用户应用唯一标识"), max_length=128, null=True)
    userid = models.CharField(_("企业微信用户应用唯一标识"), max_length=128, null=True)
    nickname = models.CharField(_("昵称"), max_length=127, blank=True)
    ...
    # 企业微信
    mobile = models.CharField(_("手机号"), max_length=11, blank=True)
    qr_code = models.CharField(_("二维码链接"), max_length=128, blank=True)
    email = models.CharField(_("邮箱"), max_length=128, blank=True)
