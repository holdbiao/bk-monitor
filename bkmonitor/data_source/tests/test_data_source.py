...
class TestDataSource:
    ...
    def test_bk_monitor_time_series_query_data(self, mock_get_ts_data):
        ...
        data_source = BkMonitorTimeSeriesDataSource.init_by_rt_query_config(query_config)
        ...
        assert (
            ...
            "WHERE time >= 12345 AND time < 54321 AND (hostname = 'host1' OR hostname = 'host2') "
            "GROUP BY bk_target_ip, bk_target_cloud_id, hostname, minute1 "
            "ORDER BY time desc LIMIT 100"
        )
        assert mock_get_ts_data.call_args[1]["prefer_storage"] == "tsdb"
        ...
        assert (
            mock_get_ts_data.call_args[1]["sql"] == "SELECT AVG(pct_used) as pct_used FROM system.mem "
            "GROUP BY bk_target_ip, bk_target_cloud_id, hostname, minute2 "
            "ORDER BY time desc LIMIT 50000"
        )
    ...
    def test_bk_data_time_series_query_data(self, mock_bk_data_query_data):
        ...
        data_source = BkdataTimeSeriesDataSource.init_by_rt_query_config(query_config)
        data = data_source.query_data()
        ...
        assert (
            ...
            "GROUP BY iWorldId, minute1 ORDER BY dtEventTimeStamp desc LIMIT 50000"
        )
        ...
        assert (
            ...
            "FROM 123_monitor_oss_online_1491 WHERE dtEventTimeStamp >= 12345 AND dtEventTimeStamp < 54321 "
    ...
    def test_custom_time_series_query_data(self, mock_get_ts_data):
        ...
        data_source = CustomTimeSeriesDataSource.init_by_rt_query_config(query_config)
        data = data_source.query_data(start_time=12345, end_time=54321, limit=100)
        ...
        assert (
            ...
            "WHERE time >= 12345 AND time < 54321 AND name = 'name1' "
            "GROUP BY minute1 ORDER BY time desc LIMIT 100"
        )
        ...
        assert (
            mock_get_ts_data.call_args[1]["sql"]
            == "SELECT AVG(test1) as test1 FROM 2_bkmonitor_time_series_1500001.base "
            "WHERE time >= 1234 AND time < 5432 GROUP BY name, minute3 ORDER BY time desc LIMIT 50000"
        )
    ...
    def test_log_search_time_series_query_data(self, mock_es_query_search):
        ...
        data_source = LogSearchTimeSeriesDataSource.init_by_rt_query_config(query_config)
        ...
        assert mock_es_query_search.call_args[1] == {
            ...
            "aggs": {
                "remote_user": {
                    ...
                    "aggregations": {
                        "dtEventTimeStamp": {
                            "date_histogram": {"field": "dtEventTimeStamp", "interval": "1m"},
    ...
    def test_log_search_log_query_data(self, mock_es_query_search):
        ...
        data_source = LogSearchLogDataSource.init_by_rt_query_config(query_config)
        data = data_source.query_data(start_time=123456, end_time=654321, limit=1000)
...
class TestBkMonitorLogDataSource:
    def test_query_data_without_topo(self, mock_get_es_data):
        ...
        data_source = BkMonitorLogDataSource.init_by_rt_query_config(query_config)
                    ...
                    "dimensions.bk_target_cloud_id": {
                        ...
                        "aggregations": {
                            "dimensions.bk_target_ip": {
                                ...
                                "aggregations": {
                                    "time": {
                                        "date_histogram": {"field": "time", "interval": "1m"},
                                        "aggregations": {
...
class TestCustomEventDataSource:
    def test_query_data(self, mock_get_es_data):
        ...
        data_source = CustomEventDataSource.init_by_rt_query_config(query_config)
        data = data_source.query_data(start_time=1614334800000, end_time=1614334860000)
