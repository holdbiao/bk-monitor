...
def create_or_update_datasource_metrics_report_path_option(data_id):
    """
    更新数据源指标上报路径
    :param data_id: 数据源ID
    """
...
class Command(BaseCommand):
    def handle(self, *args, **options):
        # 1. 更新聚合网关report path
        create_or_update_datasource_metrics_report_path_option(1100011)

        # 2. 更新运营数据上报report path
        create_or_update_datasource_metrics_report_path_option(1100012)
