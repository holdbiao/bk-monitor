...
class Label(models.Model):
    ...
    label_id = models.CharField(verbose_name=_("标签ID"), max_length=128, primary_key=True)
    label_name = models.CharField(verbose_name=_("标签名"), max_length=128)
    label_type = models.CharField(
        verbose_name=_("标签类型"),
        max_length=64,
        choices=(
            (LABEL_TYPE_SOURCE, _("数据源标签")),
            (LABEL_TYPE_RESULT_TABLE, _("结果表标签")),
            (LABEL_TYPE_TYPE, _("数据类型标签")),
        ),
    )
    is_admin_only = models.BooleanField(verbose_name=_("是否只允许管理员配置使用"), default=False)
    parent_label = models.CharField(verbose_name=_("父级标签ID"), max_length=128, null=True)
    level = models.IntegerField(verbose_name=_("标签层级"), null=True)
    index = models.IntegerField(verbose_name=_("标签排序"), null=True)
    ...
    def to_json(self):
        ...
        return {
            ...
            "label_name": _lazy(self.label_name),
