...
DEFAULT_TRIGGER_CONFIG_MAP = {
    "os": {
        DataTypeLabel.TIME_SERIES: {
            ...
            "system.disk": {"in_use": {"check_window": 5, "count": 1}},
            "system.io": {"util": {"check_window": 5, "count": 3}},
            "system_mem": {"pct_used": {"check_window": 5, "count": 1}},
        },
        DataTypeLabel.EVENT: {
            "agent-gse": {"check_window": 10, "count": 1},
            "disk-readonly-gse": {"check_window": 10, "count": 1},
            "corefile-gse": {"check_window": 5, "count": 1},
            "ping-gse": {"check_window": 5, "count": 3},
            "gse_custom_event": {"check_window": 5, "count": 1},
            "os_restart": {"check_window": 1, "count": 1},
        },
    },
    "host_process": {
        DataTypeLabel.EVENT: {
            "proc_port": {"check_window": 5, "count": 1},
            "process_restart_success": {"check_window": 5, "count": 1},
            "process_restart_failed": {"check_window": 5, "count": 1},
            "process_cancel_restart": {"check_window": 5, "count": 1},
            "process_resource_limit_exceed": {"check_window": 5, "count": 1},
            "process_group_resource_limit_exceed": {"check_window": 5, "count": 1},
        }
    },
}
    ...
    VALUEABLELIST = [
        {
            ...
            "items": [
                ...
                {"id": "target.hosts.bk_host_name", "name": _lazy("主机名"), "description": "VM_1,VM_2"},
                {"id": "target.hosts.bk_host_innerip", "name": _lazy("内网IP"), "description": "127.0.0.1,127.0.0.2"},
