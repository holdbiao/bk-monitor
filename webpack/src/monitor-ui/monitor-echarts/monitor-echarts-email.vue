<template>
  <div class="monitor-echart-wrap"
    ...
    <div class="chart-wrapper"
      ...
      <div @click.stop="handleChartClick" class="echart-instance" ref="chartRef" :style="{ height: (chartHeight - 10) + 'px' }">
        <div v-if="chartType === 'status'" :series="statusSeries"></div>
        <div v-else-if="chartType === 'text'" :series="textSeries"></div>
      </div>
    ...
    <div class="echart-content" v-if="setNoData" v-show="noData || !series || !series.length">
      <slot name="noData">
        {{emptyText}}
      </slot>
    </div>
