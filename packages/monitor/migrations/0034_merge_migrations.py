    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "component",
                    models.ForeignKey(
                        related_name="tasks", verbose_name="\u6240\u5c5e\u7ec4\u4ef6", to="monitor.ExporterComponent"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "log_collector",
                    models.ForeignKey(
                        related_name="hosts", verbose_name="\u6240\u5c5e\u91c7\u96c6\u5668", to="monitor.LogCollector"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "config",
                    models.ForeignKey(
                        related_name="tasks", verbose_name="\u6240\u5c5e\u914d\u7f6e", to="monitor.ShellCollectorConfig"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                default=1, verbose_name="\u4eea\u8868\u76d8\u83dc\u5355", to="monitor.DashboardMenu"
            ),
        ...
        migrations.AlterField(
            ...
            name="config",
            field=bkmonitor.utils.db.fields.AESTextField(verbose_name="\u7ec4\u4ef6\u914d\u7f6e"),
        ),
        migrations.AlterField(
            model_name="componentinstance",
            name="plat_id",
            field=models.CharField(default=b"1", max_length=10, verbose_name="\u5b50\u7f51ID"),
        ),
        migrations.AlterField(
