...
class KafkaQueue(object):
    ...
    def __init__(self, topic="", group_prefix="", redis_offset=True, kfk_conf=None, timeout=6):
        ...
        if kfk_conf:
            ...
            kafka_hosts = settings.KAFKA_HOST
    ...
    def get_offset_manager(self):
        ...
        #     return self.offset_manager
        # self.offset_manager = KafkaOffsetManager(self.get_consumer())
        # return self.offset_manager
    ...
    def _create_consumer(self, topic, group_name):
        for i in range(3):
            try:
                consumer = kafka.consumer.SimpleConsumer(self.client, group_name, topic, max_buffer_size=None)
