...
const origin = require('./translate-en.json')
...
}([resolve(__dirname, '../pages'), resolve(__dirname, '../components')]))
...
const ret = {}
// const x = /\s([a-zA-Z]\w+)=['"]+(\w*[\u3002\uff1f\uff01\uff0c\u3001\uff1b\uff1a\u201c\u201d\u2018\u2019\uff08\uff09\u300a\u300b\u3008\u3009\u3010\u3011\u300e\u300f\u300c\u300d\ufe43\ufe44\u3014\u3015\u2026\u2014\uff5e\ufe4f\uffe5\u4E00-\u9FA5\uF900-\uFA2D]+[^'"`<]*[\(\)\,\/\.\*%\$@\!\-\+\;\?]*[\u3002\uff1f\uff01\uff0c\u3001\uff1b\uff1a\u201c\u201d\u2018\u2019\uff08\uff09\u300a\u300b\u3008\u3009\u3010\u3011\u300e\u300f\u300c\u300d\ufe43\ufe44\u3014\u3015\u2026\u2014\uff5e\ufe4f\uffe5\u4E00-\u9FA5\uF900-\uFA2D]+\w*)['"]+/
const translate = {}
const translateZh = {}
      ...
      if (noCommentTemplate.length) {
        ...
        while (result = reg2.exec(noCommentTemplate)) {
          ...
          if (check) {
            ...
            if (!new RegExp(`>\\s+{{\\s*\\$t\\(\\s*(['\"\`])${result[1].replace('(', '\\(').replace(')', '\\)')}(\\1)\\s*}}\\s+${result[2]}`, 'gm').test(tmpContent)) {
...
const translateFileName = 'translate-en.json'
