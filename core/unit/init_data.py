...
from .models import BinarySIPrefix, DecimalSIPrefix, SimpleCountUnit, to_fixed_unit, to_percent, to_percent_unit
...
define = [
    ...
    },
    {
        ...
        "formats": [
            ...
            {"name": "nanoseconds (ns)", "id": "ns", "fn": to_fixed_unit("ns")},
            {"name": "microseconds (µs)", "id": "µs", "fn": to_fixed_unit("µs")},
            {"name": "milliseconds (ms)", "id": "ms", "fn": to_fixed_unit("ms")},
            {"name": "seconds (s)", "id": "s", "fn": to_fixed_unit("s")},
            {"name": "minutes (m)", "id": "m", "fn": to_fixed_unit("m")},
            {"name": "hours (h)", "id": "h", "fn": to_fixed_unit("h")},
            {"name": "days (d)", "id": "d", "fn": to_fixed_unit("d")},
