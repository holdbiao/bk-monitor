...
"""
"""
conf.web.production.enterprise
===========================
"""
...
DATABASES = {
    ...
    "default": {
        ...
        "USER": os.environ.get("BKAPP_SAAS_DB_USERNAME", DEFAULT_DB_USER),
        "PASSWORD": os.environ.get("BKAPP_SAAS_DB_PASSWORD", DEFAULT_DB_PASSWORD),
        "HOST": os.environ.get("BKAPP_SAAS_DB_HOST", DEFAULT_DB_HOST),
        "PORT": os.environ.get("BKAPP_SAAS_DB_PORT", DEFAULT_DB_PORT),
    },
    # 后台DB实例
    "monitor_api": {
        "ENGINE": "django.db.backends.mysql",
