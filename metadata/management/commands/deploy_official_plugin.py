...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.update_to_global_config(target_hosts=target_hosts)
    ...
    def update_to_global_config(self, target_hosts):
        qs = GlobalConfig.objects.filter(key="CUSTOM_REPORT_DEFAULT_PROXY_IP")
        if qs.exists():
