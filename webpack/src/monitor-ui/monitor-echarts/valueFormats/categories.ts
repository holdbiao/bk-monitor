...
export default (): ValueFormatCategory[] => [
  ...
  },
  {
    name: 'Data Rate',
    formats: [
      { name: 'packets/sec', id: 'pps', fn: decimalSIPrefix('p/s') },
      { name: 'bits/sec', id: 'bps', fn: decimalSIPrefix('b/s') },
      { name: 'bytes/sec', id: 'Bps', fn: decimalSIPrefix('B/s') },
      { name: 'kilobytes/sec', id: 'KBs', fn: decimalSIPrefix('B/s', 1) },
      { name: 'kilobits/sec', id: 'Kbits', fn: decimalSIPrefix('b/s', 1) },
      { name: 'megabytes/sec', id: 'MBs', fn: decimalSIPrefix('B/s', 2) },
      { name: 'megabits/sec', id: 'Mbits', fn: decimalSIPrefix('b/s', 2) },
      { name: 'gigabytes/sec', id: 'GBs', fn: decimalSIPrefix('B/s', 3) },
      { name: 'gigabits/sec', id: 'Gbits', fn: decimalSIPrefix('b/s', 3) },
