...
# 重命名并清理文件
mv ${PROJECT_DIR}/conf/api/production/enterprise_gunicorn_config.py ${PROJECT_DIR}/conf/api/production/gunicorn_config.py
rm ${PROJECT_DIR}/conf/api/production/community.py
rm ${PROJECT_DIR}/conf/api/production/community_gunicorn_config.py
