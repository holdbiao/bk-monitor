...
class MonitorConfig(AppConfig):
    ...
    def ready(self):
        from monitor.signals import dispatch
        from monitor_web.core.metric import register_metric

        # register metric factories
        register_metric(constants.INSTALLED_METRIC)
        self.clear_cache()
