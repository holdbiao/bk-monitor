...
class Item(object):
    def __init__(self, id, strategy, unit, data_source, metric_id, rt_query_config=None):
        self.id = id
        self.strategy = strategy
        self.unit = unit
        self.data_source = data_source
        self.metric_id = metric_id
        self.rt_query_config = rt_query_config
...
rt_config = {
    ...
    "algorithm_list": [
        {
            "algorithm_config": [{"threshold": 51.0, "method": "gte"}],
            "level": 3,
...
mocked_data_source = BkMonitorTimeSeriesDataSource.init_by_rt_query_config(rt_config, bk_biz_id=2, name="测试指标")
mocked_item = Item(1, Strategy(1, "os"), "%", mocked_data_source, "system.cpu_summary", rt_config)
mocked_data_source.query_data = mocked_item.query_record = mock.MagicMock(
    return_value=[
        {"mocked": "mocked", "mocked_metric": 99, "_time_": 1569246420, "minute1": 1569246420},
        {"mocked": "mocked", "mocked_metric": 1, "_time_": 1569246360, "minute1": 1569246360},
        {"mocked": "mocked", "mocked_metric": 101, "_time_": 1569246300, "minute1": 1569246300},
    ]
)
...
class TestThreshold(object):
    ...
    def test_unit(self):
        ...
        datapoint = DataPoint(
            ...
            Item(1, Strategy(1, "os"), "bytes", mocked_data_source, "system.cpu_summary"),
        )
        ...
        assert anomaly_records[0].anomaly_message == "avg(测试指标) >= 1.0KiB, 当前值1.0KiB"
