    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("config", django_mysql.models.JSONField(default=dict, verbose_name="算法配置")),
            ],
            options={
                "verbose_name": "检测配置",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("trigger_config", django_mysql.models.JSONField(default=dict, verbose_name="触发条件配置")),
                ("recovery_config", django_mysql.models.JSONField(default=dict, verbose_name="恢复条件配置")),
                (
                    "connector",
            ...
            fields=[
                ...
                (
                    ...
                    django_mysql.models.JSONField(
                        default=bkmonitor.models.strategy.no_data_config, verbose_name="无数据配置"
                    ),
                ),
                (
                    "target",
                    django_mysql.models.JSONField(
                        default=bkmonitor.models.strategy.default_target, verbose_name="监控目标"
                    ),
                ),
                ("meta", django_mysql.models.JSONField(default=list, verbose_name="查询配置元数据")),
            ],
            options={
                "verbose_name": "监控项配置",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("config", django_mysql.models.JSONField(default=dict, verbose_name="查询配置")),
            ],
            options={
                "verbose_name": "查询配置表",
