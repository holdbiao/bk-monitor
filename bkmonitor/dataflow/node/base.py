...
from core.errors.bkmonitor.dataflow import DataFlowNodeCreateFailed, DataFlowNodeUpdateFailed
...
class Node(six.with_metaclass(abc.ABCMeta, object)):
    ...
    def update(self, flow_id, node_id):
        ...
        try:
            ...
            raise DataFlowNodeUpdateFailed(node_name=self.name)
    ...
    def create(self, flow_id):
        ...
        try:
            ...
            raise DataFlowNodeCreateFailed(node_name=self.name)
