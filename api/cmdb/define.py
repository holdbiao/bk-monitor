...
class Business(TopoNode):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.bk_biz_name = bk_biz_name or ""
    ...
    def __repr__(self):
        return "<Business: {}-{}>".format(self.bk_biz_id, self.bk_biz_name)
...
class Host(BaseNode):
    ...
    def __init__(self, attrs: Optional[dict] = None, **kwargs):
        ...
        attrs["bk_cloud_id"] = int(attrs["bk_cloud_id"])
        attrs["bk_host_id"] = int(attrs["bk_host_id"])
        attrs["bk_biz_id"] = int(attrs["bk_biz_id"])
        attrs["bk_state"] = attrs.get("srv_status") or attrs.get("bk_state") or ""
        attrs["operator"] = attrs.get("operator") or []
        attrs["bk_bak_operator"] = attrs.get("bk_bak_operator") or []
        attrs["bk_set_ids"] = attrs.get("bk_set_ids") or []
        attrs["bk_module_ids"] = attrs.get("bk_module_ids") or []
        attrs["bk_os_type"] = attrs.get("bk_os_type") or ""
        attrs["bk_os_name"] = attrs.get("bk_os_name") or ""
        attrs["bk_state_name"] = attrs.get("bk_state_name") or ""
        attrs["bk_province_name"] = attrs.get("bk_province_name") or ""
        attrs["bk_isp_name"] = attrs.get("bk_isp_name") or ""
        attrs["bk_host_name"] = attrs.get("bk_host_name") or ""
        attrs["bk_os_version"] = attrs.get("bk_os_version") or ""
        attrs["bk_host_outerip"] = attrs.get("bk_host_outerip") or ""
    ...
    def __eq__(self, other):
        return (self.ip, self.bk_cloud_id) == (other.ip, other.bk_cloud_id)

    def __hash__(self):
        return hash((self.ip, self.bk_cloud_id))

    def __repr__(self):
        return "<Host: {}|{}>".format(self.ip, self.bk_cloud_id)
