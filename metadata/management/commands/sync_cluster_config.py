...
def refresh_influxdb_info():
    ...
    try:
        influxdb_ip_list = env.get_env_list("INFLUXDB_BKMONITORV3_IP")
        influxdb_port = os.environ["INFLUXDB_BKMONITORV3_PORT"]
        influxdb_username = os.environ.get("INFLUXDB_BKMONITORV3_USER", "")
        influxdb_password = os.environ.get("INFLUXDB_BKMONITORV3_PASS", "")
    ...
    influxdb_host = os.environ.get("BKMONITORV3_INFLUXDB_PROXY_HOST", None)
    influxdb_port = os.environ.get("BKMONITORV3_INFLUXDB_PROXY_PORT", None)
...
def refresh_es7_config():
    ...
    if os.environ.get("ES7_HOST", None) is None:
    ...
    try:
        es_host = os.environ["ES7_HOST"]
        es_port = os.environ["ES7_REST_PORT"]
        es_username = os.environ.get("ES7_USER", "")
        es_password = os.environ.get("ES7_PASSWORD", "")
