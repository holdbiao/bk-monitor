...
__all__ = ["load_condition_instance", "TIME_MATCH_CLASS_MAP", "load_field_instance", "load_agg_condition_instance"]
...
def load_condition_instance(conditions_config):
    """
    Load Condition instance by condition model
    ...
    for cond_item_list in conditions_config:
        ...
        for cond_item in cond_item_list:
            ...
            cond_obj = CONDITION_CLASS_MAP.get(method)(cond_field, True)
