/*
 * @Date: 2021-06-21 14:23:05
 * @LastEditTime: 2021-06-23 16:29:57
 * @Description:
 */
...
import { strategyLabel, deleteStrategyLabel } from '../../../../monitor-api/modules/strategies'
...
export default class LabelTree extends tsc<IContainerProps> {
  ...
  normalTpl(node): VNode[] {
    ...
    return [
      h('div', { class: ['normal-item-wrap'] }, [
        h('span', { class: ['item-name-wrap'] }, [
          h('i', {
            class: ['icon-monitor', 'icon-mc-triangle-down',
              { hidden: !node.children, 'to-right': !node.expanded }
            ] }),
          h('span', { class: ['item-name'] }, node.name)
        ]),
        this.mode === 'create'
          ? h(
            'span', { class: ['item-icon-group'] },
            [
              h('i', {
  ...
  tpl(node): VNode {
    ...
    return h(
      ...
      { class: [
        'tree-node-item',
        { 'node-item-active': this.checkedNode.includes(node.id) && this.mode === 'select' }
      ],
