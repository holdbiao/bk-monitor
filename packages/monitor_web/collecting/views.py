...
class CollectingConfigViewSet(IAMPermissionMixin, ResourceViewSet):
    ...
    def get_iam_actions(self):
        ...
        return super(CollectingConfigViewSet, self).get_iam_actions()
    ...
    resource_routes = [
        ...
        # 查询采集视图配置
        ResourceRoute(
            "POST", resource.collecting.get_collect_dashboard_config, endpoint="get_collect_dashboard_config"
        ),
        # 列出指定采集配置的关联策略
